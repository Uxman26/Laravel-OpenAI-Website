                    ...
                    <div class="card-body p-5 pb-0">
                                    ...
                                    <div>
                                        <h6 class="mt-1 ml-3 fs-16 number-font">{{ __($template->name) }}
                                            @if ($template->package == 'professional')
                                                <span class="fs-8 btn btn-pro ml-2"><i
                                                        class="fa-sharp fa-solid fa-crown mr-2"></i>{{ __('Pro') }}
                                                </span>
                                            @elseif($template->package == 'free')
                                                <span class="fs-8 btn btn-free ml-2"><i
                                                        class="fa-sharp fa-solid fa-gift mr-2"></i>{{ __('Free') }}
                                                </span>
                                            @elseif($template->package == 'premium')
                                                <span class="fs-8 btn btn-yellow ml-2"><i
                                                        class="fa-sharp fa-solid fa-gem mr-2"></i>{{ __('Premium') }}
                                                </span>
                                            @elseif($template->new)
                                                <span class="fs-8 btn btn-new ml-2"><i
                                                        class="fa-sharp fa-solid fa-sparkles mr-2"></i>{{ __('New') }}</span>
                                            @endif
                                        </h6>
                                    </div>
                                    <div>
                                        <a id="{{ $template->template_code }}"
                                            @if ($favorite) data-tippy-content="{{ __('Remove from favorite') }}" @else data-tippy-content="{{ __('Select as favorite') }}" @endif
                                            onclick="favoriteStatus(this.id)"><i id="{{ $template->template_code }}-icon"
                                                class="@if ($favorite) fa-solid fa-stars @else fa-regular fa-star @endif star"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-left mb-4" id="balance-status">
                                    <span class="fs-11 text-muted pl-3"><i
                                            class="fa-sharp fa-solid fa-bolt-lightning mr-2 text-primary"></i>{{ __('Your Balance is') }}
                                        <span class="font-weight-semibold" id="balance-number">
                                            @if (auth()->user()->available_words == -1)
                                                {{ __('Unlimited') }}
                                            @else
                                                {{ number_format(auth()->user()->available_words + auth()->user()->available_words_prepaid) }}
                                                {{ __('Words') }}
                                            @endif
                                        </span></span>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select id="language" name="language" class="form-select"
                                        data-placeholder="{{ __('Select input language') }}">
                                        @foreach ($languages as $language)
                                            <option value="{{ $language->language_code }}"
                                                data-img="{{ URL::asset($language->language_flag) }}"
                                                @if (auth()->user()->default_template_language == $language->language_code) selected @endif>
                            ...
                            @foreach ($template->fields as $value)
                                <div class="col-sm-12">
                                    <div class="input-box">
                                        <h6 class="fs-11 mb-2 font-weight-semibold">{{ __($value['name']) }} @if ($value['status'] == 'required')
                                                <span class="text-required"><i class="fa-solid fa-asterisk"></i></span>
                                            @endif
                                        </h6>
                                        <div class="form-group">
                                            @if ($value['input'] == 'input')
                                                <input type="text" class="form-control" id="{{ $value['code'] }}"
                                                    name="{{ $value['code'] }}"
                                                    placeholder="{{ __($value['placeholder']) }}">
                                            @elseif ($value['input'] == 'textarea')
                                                <textarea type="text" rows=5 class="form-control" id="{{ $value['code'] }}" name="{{ $value['code'] }}"
                                                    placeholder="{{ __($value['placeholder']) }}"></textarea>
                                            @elseif ($value['input'] == 'select')
                                                <select id="{{ $value['code'] }}" name="{{ $value['code'] }}"
                                                    class="form-select">
                            ...
                            @if ($template->tone)
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div id="form-group">
                                        <h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Creativity') }} <i
                                                class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                                data-tippy-content="{{ __('Increase or decrease the creativity level to get various results') }}"></i>
                                        </h6>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div id="form-group">
                                        <h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Tone of Voice') }} <i
                                                class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                                data-tippy-content="{{ __('Set result tone of the text as needed') }}"></i>
                                        </h6>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="input-box mt-5">
                                    <h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Number of Results') }} <i
                                            class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                            data-tippy-content="{{ __('Maximum supported results is 50') }}"></i></h6>
                                    <div class="form-group">
                                        <input type="number"
                                            class="form-control @error('max_results') is-danger @enderror"
                                            id="max_results" name="max_results" placeholder="e.g. 5" max="50"
                                            min="1" value="1">
                                        @error('max_results')
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="input-box mt-5">
                                    <h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Estimated Result Length') }} <i
                                            class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                            data-tippy-content="{{ __('Estimated words length for each generated text result') }}"></i>
                                    </h6>
                                    <div class="form-group">
                                        <input type="number" class="form-control @error('words') is-danger @enderror"
                                            id="words" name="words" placeholder="e.g. 100"
                                            max="{{ $limit }}" value="{{ $limit }}">
                                        @error('words')
                        ...
                        <div class="card-footer border-0 text-center p-0">
                            ...
                            <div class="w-100 pt-2 pb-2">
                                <div class="text-center">
                                    <span id="processing" class="processing-image"><img
                                            src="{{ URL::asset('/img/svgs/upgrade.svg') }}" alt=""></span>
                                    <button type="submit" name="submit"
                                        class="btn btn-primary  pl-7 pr-7 fs-11 pt-2 pb-2"
                                        id="generate">{{ __('Generate Text') }}</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="input-box mb-2">
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('document') is-danger @enderror"
                                            id="document" name="document" value="{{ __('New Document') }}">
                                        @error('document')
                                ...
                                <div class="form-group">
                                    <select id="project" name="project" class="form-select"
                                        ...
                                        @foreach ($workbooks as $workbook)
                                            <option value="{{ $workbook->name }}"
                                                @if (strtolower(auth()->user()->workbook) == strtolower($workbook->name)) selected @endif>
                                                {{ ucfirst($workbook->name) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 col-sm-12 text-right justify-content-right">
                                <div class="d-flex text-right" id="template-buttons-group">
                                    <div class="template-action-buttons">
                                        <div class="btn-group w-100">
                                            <button type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown"
                                                id="export" data-bs-display="static" aria-expanded="false"><i
                                                    class="fa-solid fa-download table-action-buttons table-action-buttons-big edit-action-button"></i></button>
                                            <div class="dropdown-menu" aria-labelledby="export"
                                                data-popper-placement="bottom-start">
                                                <a class="dropdown-item" id="copy-text"><i
                                                        class="fa-solid fa-copy fs-13 text-muted mr-2"></i>
                                                    {{ __('Copy Text') }}</a>
                                                <a class="dropdown-item" id="copy-html"><i
                                                        class="fa-brands fa-html5 fs-13 text-muted mr-2"></i>{{ __('Copy HTML') }}</a>
                                                <a class="dropdown-item" id="export-text" onclick="exportTXTEditor();"><i
                                                        class="fa-solid fa-text-size fs-13 text-muted mr-2"></i>{{ __('Text File') }}</a>
                                                <a class="dropdown-item" id="export-word"
                                                    onclick="exportWordEditor();"><i
                                                        class="fa-sharp fa-solid fa-file-word fs-13 text-muted mr-2"></i>{{ __('MS Word') }}</a>
                                    ...
                                    <a id="save-button" class="template-button" onclick="return saveText(this);"
                                        href="#"><i
                                            class="fa-solid fa-floppy-disk-pen table-action-buttons table-action-buttons-big delete-action-button"
                                            data-tippy-content="{{ __('Save Document') }}"></i></a>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            const tinymceOptions = {
                ...
                toolbar_sticky: true,
                plugins: [
                    'advlist', 'autolink', 'lists', 'charmap', 'preview', 'anchor', 'wordcount', 'autosave',
                    'link', 'image', 'code',
                ],
                ...
                setup: function(editor) {
                    const menuItems = {
                                    ...
                                    success: function(data) {
                                        ...
                                        if (data.status == 'success') {
                                            ...
                                            document.querySelector('#loader-line')
                                                ?.classList?.add('opacity-on');
                                            calculateCredits();
                                            let count = tinymce.activeEditor.plugins
                                                .wordcount.getCount();
                                            let words = document.getElementById(
                                                'total-words-templates');
                        ...
                        'simplify': {
                            ...
                            onAction: function() {
                                ...
                                formData.append('prompt',
                                    'Simplify the content below with basic words and make it clear'
                                    );
                                formData.append('content', editor.selection.getContent());
                                document.querySelector('#loader-line')?.classList?.remove(
                                    'opacity-on');
                        ...
                        'fixgrammar': {
                            ...
                            onAction: function() {
                                ...
                                let formData = new FormData();
                                formData.append('prompt',
                                    'Fix grammatical mistakes in below content');
                                formData.append('content', editor.selection.getContent());
                                document.querySelector('#loader-line')?.classList?.remove(
                                    'opacity-on');
                                $.ajax({
                            ...
                            getSubmenuItems: function() {
                                return [{
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in professional tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                            $.ajax({
                                                headers: {
                                                    'X-CSRF-TOKEN': $(
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in casual tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in exciting tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in friendly tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in witty tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in humorous tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in convincing tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in empathetic tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in inspiring tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in supportive tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in trusting tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in playful tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in positive tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in negative tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in engaging tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in worried tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in urgent tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in passionate tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in informative tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in funny tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in sarcastic tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below in dramatic tone'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                            ...
                            getSubmenuItems: function() {
                                return [{
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below using business style of writing'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below using legal style of writing'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below using journalist style of writing'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below using medical style of writing'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Rewrite the content below using poetic style of writing'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                            ...
                            getSubmenuItems: function() {
                                return [{
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Afrikaans');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Arabic');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Armenian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Azerbaijani'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Belarusian'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Bosnian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Bulgarian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Catalan');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Croatian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Czech');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Danish');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Dutch');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Estonian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Finnish');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Greek');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Hebrew');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Hungarian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Icelandic');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Indonesian'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Italian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Kazakh');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Malay');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Norwegian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Persian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Polish');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Romanian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Russian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Serbian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Slovak');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Slovenian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Swahili');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Tamil');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Thai');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Turkish');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Ukrainian');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Urdu');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Vietnamese'
                                                );
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                    ...
                                    },
                                    {
                                        ...
                                        onAction: function() {
                                            ...
                                            let formData = new FormData();
                                            formData.append('prompt',
                                                'Translate the text below to Welsh');
                                            formData.append('content', editor.selection
                                                .getContent());
                                            document.querySelector('#loader-line')
                                                ?.classList?.remove('opacity-on');
                        ...
                        onSubmit: function(api) {
                            ...
                            $.ajax({
                                ...
                                error: function(data) {
                                    ...
                                    document.querySelector('#loader-line')?.classList
                                        ?.add('opacity-on');
                                }
                    ...
                    editor.ui.registry.addMenuButton('AIOptions', {
                        icon: 'icon',
                        fetch: (callback) => {
                            const items = Object.values(menuItems).splice(1).map(val => ({
                                type: 'menuitem',
                                ...val
                            }));
                            callback(items);
                    ...
                    editor.on('ContextMenu', function(e) {
                        ...
                        setTimeout(() => {
                            ...
                            $($(".tox-collection__item-label")[0]).html(
                                '<input id="custom_prompt" type="text" class="w-100" placeholder="{{ __('What would you like to do?') }}">'
                                );
                            ...
                            $($('.tox-collection__group')[0]).prepend(
                                '<p class="tox-custom-label" id="custom_label">{{ __('Custom Action') }}</p>'
                                );
                            $($('.tox-collection__group')[1]).prepend(
                                '<p class="tox-custom-label mt-2" id="quick_label">{{ __('Quick Actions') }}</p>'
                                );
                        }, 0);
                    });
                }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data['status'] == 'error') {
                            ...
                            Swal.fire('{{ __('Text Generation Error') }}', data['message'],
                                'warning');
                            ...
                            const eventSource = new EventSource(
                                "/user/templates/original-template/process?content_id=" +
                                data.id + "&max_results=" + data.max_results +
                                "&max_words=" + data.max_words + "&temperature=" + data
                                .temperature);
                            const response = document.getElementById('richtext');
                            // let id = document.querySelector('.richText-editor').id;
                            let editor = document.getElementById('richtext');
        ...
        function favoriteStatus(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['status'] == 'success') {
                        if (data['set']) {
                            Swal.fire('{{ __('Template Removed from Favorites') }}',
                                '{{ __('Selected template has been successfully removed from favorites') }}',
                                'success');
                            ...
                            Swal.fire('{{ __('Template Added to Favorites') }}',
                                '{{ __('Selected template has been successfully added to favorites') }}',
                                'success');
                            icon = document.getElementById(id + '-icon');
                        ...
                        Swal.fire('{{ __('Favorite Setting Issue') }}',
                            '{{ __('There as an issue with setting favorite status for this template') }}',
                            'warning');
                    }
                },
                error: function(data) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['credits'] != 'Unlimited') {
                        animateValue("balance-number", parseInt(current.replace(/,/g, '')), data['credits'],
                            300);
                    }
